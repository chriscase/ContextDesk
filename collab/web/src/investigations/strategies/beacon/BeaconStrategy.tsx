...
function Browse({
  ...
  return (
      ...
      <div className="beacon__browse-filters">
        ...
        {collection.enabled && collectionQuery !== undefined ? <CollectionDiscoveryFilters query={collectionQuery} onQueryChange={onCollectionQueryChange} facets={collectionView.availability === "available" ? collectionView.value.facets : null} showEntity cursorRestartNotice={runtime.resources.investigationCollectionNotice} /> : null}
