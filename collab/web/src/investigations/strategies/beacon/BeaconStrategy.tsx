...
function Browse({
  ...
  return (
      ...
      {view.availability === "available" && filtered.length === 0 ? <StrategyStateNotice>{normalized ? "No investigations match this search or recorded filters." : collectionQuery?.entityId || collectionQuery?.contributorId ? "No investigations match the selected recorded values." : "No investigations have been recorded yet."}</StrategyStateNotice> : null}
