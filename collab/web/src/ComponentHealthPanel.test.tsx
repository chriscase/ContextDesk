    ...
    components: [
      {
        ...
        storageMigration: { state: "current" as const, current: "012_case_situation", target: "012_case_situation" },
...
describe("ComponentHealthPanel", () => {
  it("shows bounded identity, migration, compatibility, and update state without actions", async () => {
    ...
    expect(screen.getByText("012_case_situation → 012_case_situation")).toBeTruthy();
