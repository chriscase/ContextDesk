 ...
 */
import { determinismForOrigin, ACTIVITY_LANE_GROUP, type ActivityEventInput } from "./types";

export type TimezoneActivityOutcome = "applied" | "undone" | "failed" | "cancelled";
...
export function timezoneActivityEvent(args: {
  ...
  if (args.sourceCount != null) detailParts.push(`${args.sourceCount} source(s)`);
  return {
