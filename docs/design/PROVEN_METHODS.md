...
| Incident-triage evaluation bench | How can whole-strategy triage attempts on frozen historical incidents be recorded, adjudicated, and compared without a GUI and without inventing readiness? | **Local integration**: versioned case/snapshot/task/run/adjudication/score records and file-backed store (#877 / #890/#891); manual import treats human, web-only, and other-product results as first-class `TriageRun`s (#878); rubric v1 plus file/CLI expert adjudication with blinded review packets, preserved disagreement, citation assist flags (never scores), and immutable v1 scores under v2 re-adjudication (#880); honest same-task/same-snapshot report aggregation remains #881; ContextDesk SDK adapter, object storage, web collaboration, and synthesis remain #879/#883 | [Triage bench v1](../benchmarks/TRIAGE_BENCH_V1.md) · [Rubric v1](../../crates/cd-triage-bench/docs/RUBRIC_V1.md) |
