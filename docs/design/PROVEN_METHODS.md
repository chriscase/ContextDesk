...
| Log evidence pipeline          | How do raw records become honest, searchable, scalable evidence?                       | **Partial**: batch single-corpus analysis, deterministic built-in grammar fingerprints, bounded explainable noise-candidate review, and an adversarially hardened exact-template noise policy ship; #671 remains open for rule editing/identity, broader predicates/lifecycle, include-suppressed controls, and scale proof; full timestamp/profile and cross-corpus baseline work remains #670/#751/#690 | [Log evidence pipeline](proven-methods/LOG_EVIDENCE_PIPELINE.md)                   |
