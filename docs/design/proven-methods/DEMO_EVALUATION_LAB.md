...
| Collaborative War Room operator readiness | **Local integration** | Compile-first `npm run doctor` / `npm run config:init` ([operator doc](../../testing/COLLAB_OPERATOR_READINESS_V1.md)) | Configuration-shape only; not provider compatibility |
