...
- [#866](https://github.com/chriscase/ContextDesk/issues/866) — product
  embedding and reranking protocol adapters (OpenAI embeddings, Vercel v4
  embeddings, and explicit TEI/Vercel score-preserving reranking are now
  typed production slices; live quality and desktop activation remain follow-up)
