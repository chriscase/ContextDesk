...
| `log-explorer` | search/filter, partial exact-template noise policy, lanes, paging, navigator, chat, long lines | Aligned to this branch; #745 remains open for exact packaged 250,000+ tools-enabled provider proof, #671 remains open for literal residuals and suppression-specific scale proof, and packaged visual proof also remains open |
